...
#NEW PROTOCOL
addmargins(table(whipnewjaydoc$postpartum.attended.factor))
round(100*prop.table(table(whipnewjaydoc$postpartum.attended.factor)),2)

#OLD PROTOCOL
addmargins(table(whipoldjaydoc$postpartum.attended.factor))
round(100*prop.table(table(whipoldjaydoc$postpartum.attended.factor)),2)
```
